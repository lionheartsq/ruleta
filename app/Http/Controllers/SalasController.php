        ...
        //aca verifica que la sala este cumpliendo con el parametro, si llega al tope se cierra
                ...
                if($estado == '2'){
                    ...
                    if($tipoJuego == '1'){
                        ...
                        {
                            return ['puntajeActual'=> $puntajehistorico];
                        }
                    ...
                    {
                        return ['historialTurnos'=> $turnoshistorico];
                    }
                    ...
                    return ['puntajeFinal'=> $turnoshistorico];
